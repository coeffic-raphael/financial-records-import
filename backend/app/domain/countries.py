"""Officially assigned ISO 3166-1 alpha-2 country codes (249 entries).

A `^[A-Z]{2}$` regex would accept "XX" and leave INVALID_COUNTRY_CODE
meaningless. A hard-coded frozenset avoids an extra dependency for a list
that only changes every few years.
"""
